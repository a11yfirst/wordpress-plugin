...
<div class=wrap>
	...
	<h2><?php _e('AllyFirstEditor - Basic Settings', 'a11yfirsteditor_wordpress') ?></h2>
	<form method="post" >
		<?php wp_nonce_field('a11yfirsteditor_create_nonce_basic','csrf_a11yfirsteditor-for-wordpress'); ?>
		<h3><?php _e('Common Options', 'a11yfirsteditor_wordpress') ?></h3>
		<table class="form-table">
			<tr valign="top">
				<th scope="row"><?php _e('Select the skin to load', 'a11yfirsteditor_wordpress')?></th>
				<td>
			...
			<tr valign="top">
				<th scope="row"><?php _e('User Interface color', 'a11yfirsteditor_wordpress')?></th>
				<td>
					...
					<textarea style="display:none;" class="a11yfirsteditor_ui_demo" id="edit-uicolor-textarea">
